...
public class ClientChatOS {
    private class MainContext extends AbstractContext implements Context {
         ...
         * When the {@link #reader} has finished, analyses it.
         */
        ...
        /**
         * Adds {@code line} to the end of the {@link #queue} after a treatment.<br>
         * If the client is currently locked by a private connection request, only accepts {@code line}
        ...
        /**
         * Adds {@code packet} at the end of the {@link #queue} after a conversion to a buffer.
        ...
        /**
         * Sends a message depending on the first chars of the {@code line} string:
